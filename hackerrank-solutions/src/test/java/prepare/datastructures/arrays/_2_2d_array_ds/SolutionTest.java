...
public class SolutionTest {
	...
	List<List<Integer>> input0() {
		...
		r.add(integerList(1, 1, 1, 0, 0, 0));
		r.add(integerList(0, 1, 0, 0, 0, 0));
		r.add(integerList(1, 1, 1, 0, 0, 0));
		r.add(integerList(0, 0, 2, 4, 4, 0));
		r.add(integerList(0, 0, 0, 2, 0, 0));
		r.add(integerList(0, 0, 1, 2, 4, 0));
		return r;
	}
	...
	List<List<Integer>> input8() {
		List<List<Integer>> r = new ArrayList<>(6);
		r.add(integerList(-9, -9, -9, 1, 1, 1));
		r.add(integerList(0, -9, 0, 4, 3, 2));
		r.add(integerList(-9, -9, -9, 1, 2, 3));
		r.add(integerList(0, 0, 8, 6, 6, 0));
		r.add(integerList(0, 0, 0, -2, 0, 0));
		r.add(integerList(0, 0, 1, 2, 4, 0));
		return r;
	}
